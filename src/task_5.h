...
#ifndef WEEK_4_ASSIGNMENT_LIFO_FIFO_AZIZBEK1308_TASK_5_H
#define WEEK_4_ASSIGNMENT_LIFO_FIFO_AZIZBEK1308_TASK_5_H
#include <iostream>
using namespace std;
class TowerOfHanoi {
public:
...
#endif //WEEK_4_ASSIGNMENT_LIFO_FIFO_AZIZBEK1308_TASK_5_H
