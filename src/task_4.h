...
#ifndef WEEK_4_ASSIGNMENT_LIFO_FIFO_AZIZBEK1308_TASK_4_H
#define WEEK_4_ASSIGNMENT_LIFO_FIFO_AZIZBEK1308_TASK_4_H
#include <iostream>
#include <vector>
#include <stack>
using namespace std;
...
#endif //WEEK_4_ASSIGNMENT_LIFO_FIFO_AZIZBEK1308_TASK_4_H
